...
const Emoticon = () => {
  const emoticons = [
    { id: 1, label: '오히려 좋아', icon: <ImgGood24 />, count: 0 },
    { id: 2, label: '한잔해', icon: <ImgBeer24 />, count: 0 },
    { id: 3, label: '펠리컨적 사고해', icon: <ImgPelican24 />, count: 0 },
    { id: 4, label: '너 재능있어', icon: <ImgTalented24 />, count: 0 },
  ];
